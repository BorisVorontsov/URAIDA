...
//Награды и стоимость боя по картам кампании
...
const unsigned int g_uMaxDifficultyLevels = 4;
...
//Сводная таблица с данными (сложность: опыт, серебро, стоимость боя)
...
//Глава 1
{
	...
	4, {{ {21312, 8500, 16}, {21312, 8585, 16}, {21312, 8671, 16}, {21312, 8758, 16}, {21312, 8845, 16}, {21312, 8934, 16}, {21312, 9023, 18} }}
},
...
//Глава 2
{
	...
	4, {{ {21312, 9023, 16}, {21312, 9113, 16}, {21312, 9204, 16}, {21312, 9296, 16}, {21312, 9389, 16}, {21312, 9483, 16}, {23976, 9578, 18} }}
},
...
//Глава 3
{
	...
	4, {{ {23976, 9674, 16}, {23976, 9771, 16}, {23976, 9868, 16}, {23976, 9967, 16}, {23976, 10067, 16}, {23976, 10167, 16}, {26640, 10269, 18} }}
},
...
//Глава 4
{
	...
	4, {{ {26640, 10372, 16}, {26640, 10475, 16}, {26640, 10580, 16}, {26640, 10686, 16}, {26640, 10793, 16}, {26640, 10901, 16}, {26640, 11010, 18} }}
},
...
//Глава 5
{
	...
	4, {{ {29304, 11120, 16}, {29304, 11231, 16}, {29304, 11343, 16}, {29304, 11457, 16}, {29304, 11571, 16}, {29304, 11687, 16}, {29304, 11804, 18} }}
},
...
//Глава 6
{
	...
	4, {{ {31968, 11922, 16}, {31968, 12041, 16}, {31968, 12162, 16}, {31968, 12283, 16}, {31968, 12406, 16}, {31968, 12530, 16}, {31968, 12655, 18} }}
},
...
//Глава 7
{
	...
	4, {{ {31968, 12782, 16}, {31968, 12910, 16}, {31968, 13039, 16}, {31968, 13169, 16}, {31968, 13301, 16}, {31968, 13434, 16}, {31968, 13568, 18} }}
},
...
//Глава 8
{
	...
	4, {{ {31968, 13704, 16}, {31968, 13841, 16}, {31968, 13979, 16}, {31968, 14119, 16}, {31968, 14260, 16}, {31968, 14403, 16}, {34632, 14547, 18} }}
},
...
//Глава 9
{
	...
	4, {{ {34633, 14692, 16}, {34633, 14839, 16}, {34633, 14988, 16}, {34633, 15138, 16}, {34633, 15289, 16}, {34633, 15442, 16}, {00000000, 15596, 18} }}
},
...
//Глава 10
{
	...
	4, {{ {34864, 000000000, 16}, {35041, 00000000, 16}, {35041, 00000000, 16}, {35219, 00000000, 16}, {35219, 00000000, 16}, {35219, 00000000, 16}, {00000000, 00000000, 18} }}
},
...
//Глава 11
{
	...
	4, {{ {38007, 000000000, 16}, {38114, 00000000, 16}, {38114, 00000000, 16}, {38327, 00000000, 16}, {38416, 00000000, 16}, {38505, 00000000, 16}, {00000000, 00000000, 18} }}
},
...
//Глава 12
{
	...
	4, {{ {38114, 000000000, 16}, {38114, 00000000, 16}, {38416, 00000000, 16}, {38700, 00000000, 16}, {38984, 00000000, 16}, {39072, 00000000, 16}, {00000000, 00000000, 18} }}
}
}
};

//Требования опыта на каждый уровень героя (по рангам)
typedef struct tagHeroXPTable
{
	unsigned int uRank;
	std::vector<unsigned int> XPArray;
} HeroXPTable;

const unsigned int g_uMaxRank = 6;

static std::array<HeroXPTable, g_uMaxRank> g_HeroXPTable =
{
{

//★
{
	1, {897, 1118, 1393, 1736, 2163, 2695, 3359, 4185, 5215}
},

//★★
{
	2, {1110, 1258, 1426, 1616, 1831, 2075, 2351, 2664, 3019, 3421, 3876, 4392, 4977, 5640, 6390, 7241, 8205, 9298, 10536}
},

//★★★
{
	3, {1279, 1411, 1556, 1717, 1893, 2088, 2303, 2541, 2802, 3091, 3409, 3760, 4147, 4574, 5045, 5565, 6138, 6769, 7466,
	8235, 9083, 10018, 11050, 12188, 13442, 14827, 16353, 18037, 19894}
},

//★★★★
{
	4, {1460, 1591, 1734, 1890, 2060, 2245, 2447, 2666, 2906, 3167, 3451, 3761, 4099, 4467, 4868, 5305, 5782, 6301, 6867,
...
//★★★★★
{
	5, {1625, 1760, 1907, 2066, 2238, 2424, 2626, 2845, 3082, 3338, 3616, 3918, 4244, 4597, 4980, 5395, 5844, 6331, 6858,
...
//★★★★★★
{
	6, {1813, 1956, 2110, 2277, 2457, 2651, 2860, 3086, 3329, 3592, 3876, 4182, 4512, 4869, 5253, 5668, 6115, 6598, 7119,
